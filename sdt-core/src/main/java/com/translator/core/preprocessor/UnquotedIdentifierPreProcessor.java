...
public class UnquotedIdentifierPreProcessor implements SourceDialectPreProcessor {
    ...
    private static final Set<String> SQL_KEYWORDS = new HashSet<>(Arrays.asList(
            ...
            "INNER", "OUTER", "CROSS", "FULL", "NATURAL", "ORDER", "BY", "GROUP", "HAVING", "DISTINCT",
            "UNION", "ALL", "ANY", "EXISTS", "BETWEEN", "LIKE", "IS", "NULL", "TRUE", "FALSE", "CASE",
            "WHEN", "THEN", "ELSE", "END", "ASC", "DESC", "LIMIT", "OFFSET", "SET", "INTO", "VALUES",
            "INSERT", "UPDATE", "DELETE", "CREATE", "TABLE", "DROP", "ALTER", "IF", "FOR", "SOME",
            "WITH", "USING", "PRIMARY", "KEY", "FOREIGN", "INDEX", "UNIQUE", "CHECK", "DEFAULT",
            "CONSTRAINT", "ADD", "COLUMN", "REFERENCES", "FETCH", "NEXT", "ROWS", "ONLY", "EXCEPT",
            "INTERSECT", "MINUS", "COUNT", "SUM", "AVG", "MIN", "MAX", "COALESCE", "CAST", "CONVERT",
            "NULLIF", "IFNULL", "NVL", "ISNULL", "DECODE", "CONCAT", "SUBSTRING", "TRIM", "UPPER",
            "LOWER", "LENGTH", "REPLACE", "SUBSTR", "INSTR", "TO_CHAR", "TO_DATE", "TO_NUMBER",
            "TO_TIMESTAMP", "NOW", "SYSDATE", "GETDATE", "CURDATE", "CURTIME", "DATE_FORMAT",
            "DATE_ADD", "DATE_SUB", "DATEDIFF", "EXTRACT", "INTERVAL", "YEAR", "MONTH", "DAY",
            "HOUR", "MINUTE", "SECOND", "CURRENT_TIMESTAMP", "CURRENT_DATE", "CURRENT_TIME",
            "CURRENT", "TIMESTAMP", "DATE", "TIME", "TOP", "BOTTOM", "BEGIN", "COMMIT", "ROLLBACK",
            "FUNCTION", "PROCEDURE", "LANGUAGE", "RETURNS", "CALL", "RETURNING", "DO", "WINDOW",
            "OVER", "PARTITION", "UNBOUNDED", "PRECEDING", "FOLLOWING", "TIES", "ROW", "ROWS",
            "GROUPS", "OTHERS"
    ));
