...
public class PostgresTargetPostProcessor implements TargetDialectPostProcessor {
    ...
    private static final Set<String> PG_RESERVED_KEYWORDS = new HashSet<>(Arrays.asList(
            "RANGE", "USER", "KEY", "ALL", "ANALYSE", "ANALYZE", "AND", "ANY", "ARRAY", "AS", "ASC", "ASYMMETRIC",
            ...
            "FROM", "GRANT", "GROUP", "HAVING", "IN", "INITIALLY", "INTERSECT", "INTO", "LATERAL", "LEADING",
            "LIMIT", "LOCALTIME", "LOCALTIMESTAMP", "NOT", "NULL", "OFFSET", "ON", "ONLY", "OR", "ORDER", "PLACING",
            "PRIMARY", "REFERENCES", "RETURNING", "SELECT", "SESSION_USER", "SOME", "SYMMETRIC", "TABLE", "THEN",
            "TO", "TRAILING", "TRUE", "UNION", "UNIQUE", "VARIADIC", "WHEN", "WHERE", "WINDOW", "WITH"
    ));
